...
const LandingPage = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-indigo-50 pt-24 pb-12 min-h-screen flex flex-col items-center justify-center text-center px-4">
      ...
      <section className="py-20 bg-indigo-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-indigo-700 mb-10">Features</h2>
